 ...
 * @param <O> Object type
 */
public class PHTreeIndex<O extends NumberVector> extends PHTree implements RangeIndex<O>, KNNIndex<O>, DynamicIndex {
  /**
   * The appropriate logger for this index.
   */
  private static final Logging LOG = Logging.getLogger(PHTreeIndex.class);
   ...
   */
  public PHTreeIndex(Relation<O> relation, PageFile<PHTreeNode> pagefile, AbstractRTreeSettings settings) {
