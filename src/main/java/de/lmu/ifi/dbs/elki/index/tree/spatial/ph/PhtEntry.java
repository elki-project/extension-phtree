...
public class PhtEntry extends AbstractDirectoryEntry implements Entry {
   ...
   */
  public PhtEntry(DBID objectID, double parentDistance, Integer nodeID, double coveringRadius) {
    super(nodeID);
  ...
  public boolean equals(Object o) {
    ...
    final PhtEntry that = (PhtEntry) o;
//
