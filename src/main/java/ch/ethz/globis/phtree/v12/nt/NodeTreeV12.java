...
import ch.ethz.globis.phtree.v12.Bits;
...
public class NodeTreeV12<T> implements NodeTree64<T> {
	...
	/* (non-Javadoc)
	 * @see ch.ethz.globis.phtree.v12.nt.NodeTree64#put(long, long[], T)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ch.ethz.globis.phtree.v12.nt.NodeTree64#putB(long, long[])
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ch.ethz.globis.phtree.v12.nt.NodeTree64#contains(long, long[])
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ch.ethz.globis.phtree.v12.nt.NodeTree64#get(long, long[])
	 */
	@Override
	@SuppressWarnings("unchecked")
	...
	/* (non-Javadoc)
	 * @see ch.ethz.globis.phtree.v12.nt.NodeTree64#remove(long)
	 */
	@Override
	@SuppressWarnings("unchecked")
	...
	/* (non-Javadoc)
	 * @see ch.ethz.globis.phtree.v12.nt.NodeTree64#removeB(long)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ch.ethz.globis.phtree.v12.nt.NodeTree64#toStringTree()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ch.ethz.globis.phtree.v12.nt.NodeTree64#queryWithMask(long, long)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ch.ethz.globis.phtree.v12.nt.NodeTree64#query(long, long)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ch.ethz.globis.phtree.v12.nt.NodeTree64#iterator()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ch.ethz.globis.phtree.v12.nt.NodeTree64#checkTree()
	 */
	@Override
