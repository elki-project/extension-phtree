...
import ch.ethz.globis.phtree.v11.PhResultList.PhEntryFactory;
 ...
 *
 */
public class PhTree11<T> extends PhTree<T> {
...
//		}
    ...
    PhEntryFactory<T> fac = new PhEntryFactory<T>() {
      @Override
      public PhEntry<T> create() {
        return new NodeEntry<>(new long[dims], null);
      }
    };
		
		PhResultList<T, R> list = new PhResultList.MappingResultList<>(null, mapper, fac);
